...
//                        assert(s.start.toLocalTime().toString().startsWith("10:00"))
//                        assert(s.end.toLocalDate().toString().startsWith("11:00"))
                        s.start.toLocalTime().toString() shouldBe "10:00"
                        s.end.toLocalTime().toString() shouldBe "11:00"
                    }
                }
            }
        }
